...
echo "<table id='table'><tr><th>Run Name</th><th>Start Date/Time</th><th>Price</th><th>Maximum Registrations</th><th>Sign Up</th></tr>";
						foreach($rows as $row) {

							echo "<tr><td>" . $row["name"] . "</td><td>" . $row["startdate"] . "</td><td> $" . $row["price"] . "</td><td>" . $row["maxregistrations"] .  "</td>";
              echo "<td>" . "<a href="/success.php">" . "Sign Up" . "</a>" . "</td>";
						}
            echo "</table>";
